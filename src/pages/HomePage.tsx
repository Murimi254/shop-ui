...
const HERO_SLIDES = [
  ...
  { id: 2, brand: "Samsung", title: "Galaxy S23", subtitle: "New Arrivals", cta: "Shop Now", bg: "bg-black" },
  { id: 3, brand: "Sony", title: "PlayStation 5", subtitle: "Limited Stock", cta: "Shop Now", bg: "bg-black" },
];
    ...
    <div className="max-w-300 mx-auto px-4">
        ...
        <div className="flex-1 relative bg-black rounded overflow-hidden ml-0 lg:ml-6 min-h-[340px]">
          <div className="absolute inset-0 flex items-center justify-between p-8">
            <div className="text-white z-10">
              ...
              <Link to="/" className="flex items-center gap-2 text-white border-b border-white pb-1 hover:text-gray-300 transition-colors w-fit">
            ...
            <div className="absolute right-8 top-1/2 -translate-y-1/2 opacity-80">
              <img src="https://placehold.co/280x280/111111/ffffff?text=Product" alt="hero product" className="w-64 h-64 object-contain" />
            </div>
          </div>
      ...
      <section className="mb-16 rounded overflow-hidden bg-black relative min-h-[300px] flex items-center px-12">
        <div className="z-10 text-white">
          ...
          <Button className="mt-6 bg-[#00ff66] text-black hover:bg-[#00dd55] font-semibold">Buy Now!</Button>
        </div>
        <div className="absolute right-12 top-1/2 -translate-y-1/2">
          <img src="https://placehold.co/350x280/111111/333333?text=Speaker" alt="JBL Speaker" className="w-72 h-56 object-contain" />
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-[500px]">
          ...
          <div className="bg-black rounded overflow-hidden relative group cursor-pointer h-full">
            <img
              src="https://placehold.co/600x500/111111/333333?text=PlayStation+5"
              alt="PS5"
          ...
          <div className="grid grid-rows-2 gap-4 h-full">
            ...
            <div className="bg-[#1a1a1a] rounded overflow-hidden relative group cursor-pointer">
              <img
                src="https://placehold.co/600x220/1a1a1a/555555?text=Women%27s+Collections"
                alt="Women's Fashion"
                className="w-full h-full object-cover opacity-80 group-hover:opacity-90 transition-opacity"
              />
              <div className="absolute bottom-4 left-4 text-white">
                ...
                <Link to="/" className="text-xs font-semibold underline">
                  Shop Now
                </Link>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-[#1a1a1a] rounded overflow-hidden relative group cursor-pointer">
                <img
                  src="https://placehold.co/280x200/1a1a1a/555555?text=Speakers"
                  alt="Speakers"
                  className="w-full h-full object-cover opacity-80 group-hover:opacity-90 transition-opacity"
                />
              ...
              <div className="bg-[#1a1a1a] rounded overflow-hidden relative group cursor-pointer">
                <img
                  src="https://placehold.co/280x200/1a1a1a/555555?text=Perfume"
                  alt="Perfume"
                  className="w-full h-full object-cover opacity-80 group-hover:opacity-90 transition-opacity"
                />
                <div className="absolute bottom-3 left-3 text-white">
